<?php
	...
	class UploadComponent extends Object {
		...
		function upload ($file, $destination, $name = NULL, $rules = NULL, $allowed = NULL) {
			...
			if (!is_null($allowed)) { $this->_allowed = $allowed; } else { $this->_allowed = array('xls','doc','txt','rtf','pdf','jpg','jpeg','gif','png','docx','DOCX','XLS','DOC','TXT','RTF','PDF','JPG','JPEG','GIF','PNG'); }
	  ...
	  function create_thumbnail($file_name,$path) {
        $file_path = $path.$file_name ;
        $thumbnail_path = $path.'thumbs'.DS.$file_name ;
        ...
        $thumbnail_width = 148 ;//$img_width * $scale;
        $thumbnail_height =100 ;$img_height * $scale;
