<div class="carteCredits view">
<h2><?php  __('Carte Credit');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $carteCredit['CarteCredit']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $carteCredit['CarteCredit']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Carte Credit', true), array('action' => 'edit', $carteCredit['CarteCredit']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Carte Credit', true), array('action' => 'delete', $carteCredit['CarteCredit']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $carteCredit['CarteCredit']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Carte Credits', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Carte Credit', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($carteCredit['Hotel'])):?>
	...
	<?php
		$i = 0;
		foreach ($carteCredit['Hotel'] as $hotel):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
