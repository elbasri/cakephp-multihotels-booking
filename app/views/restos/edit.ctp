<div class="form">
	...
	<?php echo $this->IForm->create('Resto');?>
	<h3>	<?php if ($ave == 'A') {
					echo 'Ajout Resto';
					}elseif ($ave == 'E') {;
					echo	'Modification Resto';
					} else {
					echo	'Consultation Resto';
					}
				?>
	</h3>		
<?php
	...
	<div class="portlet-content">
			<?php
				echo '<div class="x10" id="dfr">'	;
					...
					echo $this->Form->textarea('resto',array('label'=>false));
					echo $this->IForm->editor('resto');
				echo '</div>' 
			?>
	</div>
</div>
