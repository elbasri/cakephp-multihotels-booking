	...
	<div class="chambre_header">
		...
		<div class="price-box">A partir de 
			...
			/*$url = Router::url(array(
					'controller' => 'pages',
					'action' => 'prixc',$c['id'],$idhot
				));
				*/
			$this->requestAction('pages/prixc/'.$c['id'].'/'.$idhot);
			//echo "lewla:".$c['id']."tanya:".$idhot."mmmmm";
			//$this->requestAction(array('controller' => 'pages', 'action' => 'prixc',$c['id'],$idhot));
			//echo $prix;
			//echo $this->Front->toDevise($c['tarif'],$h['Devise']);
