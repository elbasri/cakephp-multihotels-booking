<div class="langues view">
<h2><?php  __('Langue');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $langue['Langue']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $langue['Langue']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Langue', true), array('action' => 'edit', $langue['Langue']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Langue', true), array('action' => 'delete', $langue['Langue']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $langue['Langue']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Langues', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Langue', true), array('action' => 'add')); ?> </li>
