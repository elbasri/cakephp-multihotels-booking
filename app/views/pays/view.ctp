...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Pay', true), array('action' => 'edit', $pay['Pay']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Pay', true), array('action' => 'delete', $pay['Pay']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $pay['Pay']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Pays', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Pay', true), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View', true), array('controller' => 'villes', 'action' => 'view', $ville['id'])); ?>
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'villes', 'action' => 'edit', $ville['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'villes', 'action' => 'delete', $ville['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $ville['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
