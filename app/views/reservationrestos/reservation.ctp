...
<h4 style="color: #231F20;float: right; font-family: arial;font-size: 17pt;width: 261pt;" > Détails d'Reservationresto </h4>
</div>
	<div class="catBox">
		<div class="catBinfo prodviewbox">
			<h2 style="border-bottom: 1px solid #CCCCCC;color: #07759F;float: left;font-family: Verdana,Geneva,Arial,Helvetica,sans-serif;font-size: 12px;font-weight: bold;margin-left: 7px;padding-bottom: 10px;padding-top: 5px;text-transform: uppercase;width: 95%;">Resto</h2>
            ...
            <ul style=" float: left; list-style: none outside none; margin: 0; padding: 0; width:100%;" >
                  <li style="margin-bottom: 10px;text-align: justify;color:#545557;" > <span style="color: #FF0066;float: left;width: 70px;" >Titre :  </span><?php echo $p['Resto']['titre']?>  </li>
                  <li> <span style="color: #FF0066;float: left;width: 70px;"> Prix :</span><?php echo $p['Resto']['prix']." "; ?> </li>
            </ul>
			</span>
		</div>
	</div>
    ...
    <!--        cette span entre la balise <p>-->
            ...
            <?php echo $r['Reservationresto']['name'] ?></p>
			...
			<?php echo $r['Reservationresto']['tel'] ?> 
			</p>
			<p style=" float: left; width: 100%;margin:5px 0 0 5px;color:#545557;"><span style=" color: #FF0066;  float: left;  width: 70px;">Email :</span> 
			<?php echo $r['Reservationresto']['email'] ?> 
			</p>
			<p style=" float: left; width: 100%;margin:5px 0 0 5px;color:#545557;"><span style=" color: #FF0066;  float: right;"><a href="<?=$this->Html->url('/resto/').$p['Resto']['id']?>">Cliquer ici pour afficher les détails du Resto</a></span> 
			</p>
	</div>
