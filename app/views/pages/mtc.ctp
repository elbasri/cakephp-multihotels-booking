...
<?php
/*
$myredirect='http://votrecodeur.com/mtc/redirect.php';
$mycallback = 'http://votrecodeur.com/mtc/callback.php';

$cartId=$r['Reservation']['id'];
$email=$r['Reservation']['email'];
$amount=$r['Reservation']['montant']. "<br>";
$qte=$r['Reservation']['qte']. "<br>";
$totalAmountTx=$r['Reservation']['payement']*$r['Devise']['taux'] . "<br>";
...
$c2pClient->setAmount($totalAmountTx * 100);
...
//$c2pClient->setMerchant('Booking Pro Script [French Version] Script de Centrale de résérvation profesionnel By VotreCodeur.com ');
