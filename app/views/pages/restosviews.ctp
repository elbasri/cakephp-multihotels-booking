<div class="viewpage">
	...
	<div class="catBox">
		...
		<div class="catBinfo prodviewbox" style="width:70%">
			<h2><?php echo $p['Resto']['titre']?></h2>
			<span class="resultnum">
				<?php echo $p['Resto']['desc'] ?>
			</span>
		</div><!--end catBinfo-->
		
		 <div class="priceinfoBox">
			<div class="stars"><img src="<?php echo $this->Html->url('/img/stars/star'.$p['Resto']['star'].'.png')?>" alt="stars" /></div>
			<div class="price-box">Prix <span class="price">
							<?php echo round($p['Resto']['prix']/$this->Session->read('Devise.taux'))?>
	...
	<?php if($test==1){ ?>
		<h1 style="color:red">Votre commande est maintenant en cours de traitement et vous serez avisé quand vos Restos seront prêts à vous être envoyés.</h1>
	<?php }?>
	
	<div class="viewsProdBox">
		
		<div class="prodpreview" style="width:70%">
			<img style="width:100%;height:300px; box-shadow: 2px 2px 2px 2px #000; " src="<?php echo $p['Resto']['image'];?>" />
		</div>
		<div class="othersViews" style="width:28%">
<div id="info_groupe">	
<fieldset><legend><strong><h3>Acheter ce Resto</h3></strong></legend>
