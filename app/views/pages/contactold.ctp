...
<div id="contenu_contact">
			<div class="left-contact">
					<?php
					$your_email ='resa@votrecodeur.com';
...
<td><label for='email'></label></td>
	...
	<div id="info_groupe">
			...
			<hr>
			<p>
		  Daoudiate Rue Almouzdalifa Immeuble Sami 2ème étage B : 9<br>
		  Marrakech- Maroc
			</p>
		

			<span class="infos_span_groupe">
				<img class="icon_infos" alt="luxia booking" src="<?php echo $this->Html->url('/img/phone_groupe.png'); ?>"></span><span class="infos_texte">+212 524 31 34 60   </span>
				<span class="infos_span_groupe"><img class="icon_infos" alt="luxia booking" src="<?php echo $this->Html->url('/img/phone_groupe.png'); ?>"></span><span class="infos_texte">+212 662 81 68 76</span>
                <span class="infos_span_groupe"><img class="icon_infos" alt="Booking Pro Script [French Version] By VotreCodeur.com" src="<?php echo $this->Html->url('/img/mail_groupe.png'); ?>"></span><span class="infos_texte">resa@votrecodeur.com</span>
